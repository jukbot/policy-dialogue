      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="600" viewBox="0 0 780 390">
        <g data-name="Group 1572">
          <path
            ...
            fill="#fff"
          />
          <text transform="translate(440 90)" fontSize="2.5rem" fontFamily="IBMPlexSansThai,san-serif" fontWeight="600" fill="#2b2b2b">
            <tspan x="-230.025" y="0">
              กระบวนการหาคำตอบ
            </tspan>
          </text>
          <text transform="translate(120 130)" fontSize="1.5rem" fontFamily="IBMPlexSansThaiLooped,san-serif" fill="#2b2b2b">
            <tspan x="75.238" y="28">
              RISE Impact{' '}
            </tspan>
