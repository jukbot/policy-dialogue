    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="600" viewBox="0 0 780 390">
      <g data-name="Group 1572">
        <path
          ...
          fill="#fff"
        />
        <text transform="translate(440 90)" fontSize="2.5rem" fontFamily="IBMPlexSansThai,san-serif" fontWeight="600" fill="#c7642a">
          <tspan x="-230.025" y="0">
            กระบวนการหาคำตอบ
          </tspan>
        </text>
        <text
          data-name="RISE Impact ได้จัดกระบวนการหารือ เชิงนโยบาย ในประเด็นนี้ทั้งหมด 5 ครั้ง รวมผู้เข้าร่วมกว่า 79 คน"
          transform="translate(120 130)"
          fontSize="1.5rem"
          fontFamily="IBMPlexSansThaiLooped,san-serif"
          fill="#c7642a"
        >
          <tspan x="75.238" y="28">
            RISE Impact{' '}
          ...
          <tspan x="68.15" y="69">
            เชิงนโยบาย ในประเด็นนี้ทั้งหมด 5 ครั้ง{' '}
          </tspan>
          <tspan x="146.688" y="110">
            รวมผู้เข้าร่วมกว่า 79 คน
          </tspan>
        </text>
      </g>
    </svg>
