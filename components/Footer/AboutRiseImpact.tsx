...
const AboutRiseImpact = () => {
  return (
    <div className="flex justify-center w-full max-w-5xl">
      <div className="flex flex-col items-center justify-between w-full p-8 bg-local bg-white bg-no-repeat bg-contain sm:px-24 md:flex-row rounded-xl md:bg-footer-size bg-top-right md:bg-rise-impact-footer">
        <div>
