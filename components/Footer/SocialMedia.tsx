...
const SocialMedia = (): JSX.Element => {
  return (
    <div className="flex justify-center space-x-8 md:justify-start">
      <a href={Meta.facebookUrl} target="_blank" rel="noreferrer noopener" className="text-link">
      ...
      <a href={Meta.linkedin} target="_blank" rel="noreferrer noopener" className="text-link">
      ...
      {/* <a href={Meta.twitterUrl} target="_blank" rel="noreferrer noopener" className="text-link">
      ...
      {/* <a href={Meta.lineUrl} target="_blank" rel="noreferrer noopener" className="text-link">
      ...
      <a href={Meta.youtubeUrl} target="_blank" rel="noreferrer noopener" className="text-link">
