...
const SocialMedia = (): JSX.Element => {
  return (
    <div className="flex justify-center space-x-8 md:justify-start">
      <a href={Meta.facebookUrl} target="_blank" rel="noreferrer noopener" className="text-link" title="facebook">
      ...
      <a href={Meta.linkedin} target="_blank" rel="noreferrer noopener" className="text-link" title="linkedin">
      ...
      <a href={Meta.youtubeUrl} target="_blank" rel="noreferrer noopener" className="text-link" title="youtube">
      ...
      {/* <a href={Meta.twitterUrl} target="_blank" rel="noreferrer noopener" className="text-link" title="twitter">
      ...
      {/* <a href={Meta.lineUrl} target="_blank" rel="noreferrer noopener" className="text-link" title="line">
