    ...
    <div className="relative grid max-w-6xl grid-cols-1 gap-8 px-6 mx-auto md:px-12 md:gap-16 md:grid-cols-2 transition duration-300">
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0" width="64" height="64" priority aria-hidden="true" src={Authority} alt="authority" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0" width="64" height="64" priority aria-hidden="true" src={Developer} alt="developer" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0" width="64" height="64" priority aria-hidden="true" src={UsageStaff} alt="usage staff" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0" width="64" height="64" priority aria-hidden="true" src={AffectPerson} alt="affect person" />
