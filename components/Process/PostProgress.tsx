    ...
    <div className="relative grid max-w-6xl grid-cols-1 gap-8 px-6 mx-auto md:px-12 md:gap-16 md:grid-cols-3">
      ...
      <div className="flow-root">
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed sm:text-base font-body">
            กิจกรรมที่ให้ผู้เข้าร่วมทำแบบสอบถาม หรือโหวต แล้วนำผลมาแสดงทันที เพื่อใช้ผลนั้น ๆ ในกระบวนการต่อไป
          </p>
        </div>
      </div>
      ...
      <div className="flow-root">
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed sm:text-base font-body">
            การยกตัวอย่าง case study เส้นทางชีวิตคนไข้เมื่อเจ็บป่วยในช่วงชีวิตต่าง ๆ เพื่อให้ผู้เข้าร่วมเห็นภาพชัดเจน ได้ insight ที่ค่อนข้างละเอียด
      ...
      <div className="flow-root">
        <div className="space-y-4">
          ...
          <p className="text-sm leading-relaxed sm:text-base font-body">
            ใช้เว็บแอปพลิเคชั่นเพื่อสื่อสารและสำรวจความคิดเห็นในวงกว้าง สร้างการรับรู้ต่อประเด็นนั้น ๆ
