    ...
    <div className="relative grid max-w-6xl grid-cols-1 gap-8 px-6 mx-auto md:px-12 md:gap-16 md:grid-cols-3">
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="w-12 h-12 shrink-0" width="48" height="48" aria-hidden="true" src={Seminar} alt="seminar" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="w-12 h-12 shrink-0" width="48" height="48" aria-hidden="true" src={LiteratureReview} alt="literature review" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="w-12 h-12 shrink-0" width="48" height="48" aria-hidden="true" src={InternalMeeting} alt="internal meeting" />
