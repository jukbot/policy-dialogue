    ...
    <div className="relative grid max-w-6xl grid-cols-1 gap-8 px-6 mx-auto md:px-12 md:gap-16 md:grid-cols-3">
      <div className="flow-root">
        <div className="space-y-3">
          <Image className="shrink-0 w-12 h-12" width="48" height="48" aria-hidden="true" src={Interview} alt="intervew" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0 w-12 h-12" width="48" height="48" aria-hidden="true" src={Seminar} alt="seminar" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0 w-12 h-12" width="48" height="48" aria-hidden="true" src={Fieldwork} alt="fieldwork" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0 w-12 h-12" width="48" height="48" aria-hidden="true" src={LiteratureReview} alt="literature review" />
      ...
      <div className="flow-root">
        <div className="space-y-4">
          <Image className="shrink-0 w-12 h-12" width="48" height="48" aria-hidden="true" src={InternalMeeting} alt="internal meeting" />
