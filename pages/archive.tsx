  ...
  return (
    <div className="relative">
      <main className="relative">
        <section className="relative grid h-[50vh] lg:h-[75vh] bg-bottom bg-contain bg-no-repeat transition flex items-center bg-about-pattern-mobile sm:bg-about-pattern">
