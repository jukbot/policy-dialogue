      ...
      <section className="relative h-full space-y-12 bg-white">
        <div className="max-w-6xl px-6 py-16 mx-auto space-y-12 sm:px-12 text-body">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="flex flex-col place-content-between space-y-6 p-6 bg-[#c7642a] h-48 text-white">
              <div className="flex space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-8 h-8 fill-current current-color" viewBox="0 0 30 30">
                  <path
                    data-name="Path 278"
            ...
            <div className="flex flex-col place-content-between space-y-6 p-6 bg-[#a8a8a8] h-48 text-white">
              <div className="flex space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-8 h-8 fill-current current-color" viewBox="0 0 50 45">
                  <path
                    data-name="Path 130"
            ...
            <div className="flex flex-col place-content-between space-y-6 p-6 bg-[#a8a8a8] h-48 text-white">
              <div className="flex space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-8 h-8 fill-current current-color" viewBox="0 0 50 50">
                  <path
                    id="Path_56"
                    data-name="Path 56"
            ...
            <div className="flex flex-col place-content-between space-y-6 p-6 bg-[#a8a8a8] h-48 text-white">
              <div className="flex space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-8 h-8 fill-current current-color" viewBox="0 0 47.812 45">
                  <path
                    data-name="Path 236"
            ...
            <div className="flex flex-col place-content-between space-y-6 p-6 bg-[#3f36b7] h-48 text-white">
              <div className="flex space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-8 h-8 fill-current current-color" viewBox="0 0 50.625 45">
                  <path
                    data-name="Path 129"
            ...
            <div className="flex flex-col place-content-between space-y-6 p-6 bg-[#daa13d] h-48 text-white">
              <div className="flex space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-8 h-8 fill-current current-color" viewBox="0 0 50 44.978">
                  <path
                    data-name="Path 55"
            ...
            <div className="flex flex-col place-content-between space-y-6 p-6 bg-[#a8a8a8] h-48 text-white">
              <div className="flex space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-8 h-8 fill-current current-color" viewBox="0 0 50 36.853">
                  <path
                    data-name="Path 237"
          ...
          <div className="grid grid-cols-1 gap-8 pb-6 border-b border-gray-500 md:grid-cols-2">
            ...
            <div className="col-span-1 space-y-6">
              <p className="text-sm leading-relaxed font-body">
                รัฐบาลไทยหลายยุคหลายสมัยได้ให้ความสำคัญกับนโยบายที่เกี่ยวข้องกับผู้สูงอายุ รวมถึงการพิทักษ์สิทธิของผู้สูงอายุมาโดยตลอด แต่กระบวนการทำงานของ กผส.
                และคณะอนุกรรมการต่างๆ ยังขาดการมีส่วนร่วมของภาคประชาชน
              </p>
              <p className="text-sm leading-relaxed font-body">
