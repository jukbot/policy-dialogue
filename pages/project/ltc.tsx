          ...
          <div className="relative py-12 mx-auto max-w-7xl lg:py-24 lg:mb-24">
            <div className="relative grid grid-cols-1 gap-6 md:gap-0 xl:gap-6 md:grid-cols-2">
              <div className="relative flex flex-col col-span-1 space-y-6 text-body">
                <div className="px-6 space-y-6 top-36 md:sticky lg:px-12">
                  ...
                  <div className="left-0 w-full px-6 overflow-hidden md:absolute md:px-0">
                ...
                <ul className="space-y-12">
                  ...
                  <li className="space-y-2 md:space-y-4">
                    ...
                    <p className="font-body">
                      ...
                      <br />
                      <br />
                      ตัวแทนบุคลากรสาธารณสุข ตระหนักถึงความทุกข์ของญาติในการดูแลผู้ป่วย ทำให้อยากพัฒนางานต่อ และเห็นโอกาสในการจัดการอบรมให้ญาติหรือ
                  ...
                  <li className="space-y-2 md:space-y-4">
                    ...
                    <p className="font-body">
                      ...
                      แต่อาจให้ผลดีกว่า เช่น ระบบพี่เลี้ยง ทั้งยังเห็นความสำคัญของการมีวงหารือแลกเปลี่ยนกัน โดยมีหน่วยงานส่วนกลางเป็นเจ้าภาพหลัก
                  ...
                  <li className="space-y-2 md:space-y-4">
                    ...
                    <p className="font-body">
                      ผู้เข้าร่วมเห็นประโยชน์ในการร่วมแลกเปลี่ยนจากมุมการทำงานของตัวเอง เห็นความเชื่อมโยงแม้มีบทบาทต่างกัน
